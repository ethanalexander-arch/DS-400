...
##
## Your answer:
##the mean stays the same in this case 
##the credible interval becomes much thinner.
##this happens because there are more prior cases so it is more likely
##to have the support fall closer to the mean
## ------------------------------------------------------------
...
##
## Your answer:
##alpha = beta = 1 has no mode because with one prior success and failure 
##there is no data way to predict where the true suport will fall
##alpha = beta = 0.5 has no mode because there are no prior successes or failures.
##this mean the graph will have a higher density around the 0 and 1 because the next vote will skew the graph that way.
## ------------------------------------------------------------
...
##
## Your answer:
##the scaled likely hood and the posterior are the exact same graph. 
##this is because the prior is a straight line and isnt a distribution
## ------------------------------------------------------------
...
##
## Your answer:
##it shifts the weight strongly towards the added data 
##this tells me that for new data to overrule a prior it has to have more trials
## ------------------------------------------------------------
...
##
## Your answer:
##the Bayesian interval can tell us the likelihood that support will fall in a certain area
##the frequentist interval is only there to tell us that through many tries the support
## will land between a certain area
##
## ------------------------------------------------------------
...
##
## Your answer:
##the posterior ends up closer to the data here. yes it does match the weight sentance.
##this happens because the data here has twice as many trials as the prior
##
## ------------------------------------------------------------
...
##
## Your answer:
## political support changes over time and they will change very quickly when an 
## event involving the candidate happens. an old poll does not have much or any 
## weight on a newer poll. to make this better a routing poll of general support will be much better.s
##
## ============================================================
